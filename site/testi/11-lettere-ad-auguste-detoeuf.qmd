...
description: "Mi rimprovero molto di non riuscire a farmi comprendere pienamente da lei, perché è certamente colpa mia. Se il mio progetto dovrà realizzarsi un giorno…"
---

<!-- Generato da scripts/build_site.py a partire da corpus/it/11_lettres_a_auguste_detoeuf.md. Non modificare a mano. -->

[*La Condizione Operaia*, Gallimard, Parigi 1951, pp. 181-195.]{.riferimento}
...
*P.-S.* — Ha visto *Tempi moderni*[^11-1], suppongo? La macchina per mangiare: ecco il simbolo più bello e più vero della situazione degli operai nella fabbrica. <a id="p185"></a><!-- page: 185; scan: Page:Weil - La Condition ouvrière, 1951.djvu/197 -->
...
[^11-1]: Film di Charlie Chaplin.

[^11-2]: *Nouveaux Cahiers*, 15 dicembre 1937. — Corrispondenza tra S. Weil e A. Detœuf.
